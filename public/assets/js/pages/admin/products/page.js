jQuery.index = {
    ...
    init: function () {
        ...
        self.data.searchInput = $('#search-products');
        ...
        self.data.table = $('#ohmytable').DataTable({
            ...
            columns: [
                        ...
                        if (data.thumbnail) {
                            return `
                                <div class='d-flex justify-content-center align-items-center'>
                                    <img src='/uploads/products/${data.thumbnail}' alt='Thumbnail' class='rounded' width='150' height='150' style="object-fit: cover;"/>
                                </div>
                            `;
                        } else {
                            return `
                ...
                },
                {
                    ...
                    width: '20%',
                    render: function (data) {
                        return "<b>" + data.name + "</b><br><hr>" + data.category.name;
                    }
                },
                {
                    data: null,
    ...
    setEvents: function () {
        ...
        $("#ohmytable").on('click', "button.btn-hapus", function () {
            ...
            $.confirm({
                ...
                type: 'orange',
                columnClass: 'small',
                content: 'Apakah Anda yakin ingin menghapus produk <strong>' + name + '</strong>? Data yang telah dihapus tidak dapat dikembalikan.',
                buttons: {
                    cancel: {
                        text: 'Tidak',
                        btnClass: 'btn-red',
