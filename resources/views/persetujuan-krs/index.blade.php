                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p class="mb-1"><strong>Role:</strong> {{ $rs->user->role->name ?? '-' }}
                                                    </p>
                                                    ...
                                                    <p><strong>Tanggal Pengajuan:</strong>
                                                        {{ $rs->created_at->format('d/m/Y H:i') }}</p>
                                                        ...
                                                        <table class="table table-sm">
                                                            ...
                                                            <tbody>
                                                                @forelse($rs->mataKuliahList as $mk)
                                                                    <tr>
                                                                        <td>{{ $mk->kode ?? '-' }}</td>
                                                                        <td>{{ $mk->nama ?? ($mk->nama_matakuliah ?? '-') }}
                                                                        </td>
                                                                        <td>{{ $mk->sks ?? '-' }}</td>
                                                                    </tr>
                                                                @empty
                                                                    <tr>
                                                                        <td colspan="3" class="text-center">Tidak ada mata
                                                                            kuliah</td>
                                                                    </tr>
                                                                @endforelse
                                                            </tbody>
